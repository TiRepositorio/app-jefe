...
//    private var colores : MutableList<Int> = MutableList(10){0}
//
...
//        colores.add(1,Color.parseColor("#C27DFF"))
...
//        colores.add(6,Color.parseColor("#B65500"))
//        colores.add(7,Color.parseColor("#517E1F"))
